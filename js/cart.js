/**
 * ALHAH INDUSTRIES — Shopping Cart & Enquiry System
...
// ── EmailJS CONFIG ─────────────────────────────────────────────
const EMAILJS_PUBLIC_KEY  = '64Ymh2ML57weuHj8J';
const EMAILJS_SERVICE_ID  = 'service_zmm3sh6';
const EMAILJS_TEMPLATE_ID = 'template_42tifcj';
...
(function () {
  ...
  function addItem(product) {
    ...
    saveCart(c);
    toast('<i class="fas fa-check-circle"></i> Added to enquiry cart');
    pulseBadge();
  }
    ...
    if (!c.length) {
      body.innerHTML = `
        <div class="cart-empty">
          ...
          <h5 style="font-weight:700;color:#1a1a2e;margin-bottom:6px;">Cart is empty</h5>
          <p style="font-size:.85rem;color:#888;">Browse our categories and add instruments to build your enquiry.</p>
        </div>`;
  ...
  function confirmClear() {
    if (confirm('Remove all items from your enquiry cart?')) clearAll();
  }
  ...
  function injectCartHTML() {
    ...
    <div id="cartDrawer" class="cart-drawer">
      <div class="cart-drawer-header">
        <div>
          <h3><i class="fas fa-shopping-bag me-2" style="color:#00C49A"></i>Enquiry Cart</h3>
      ...
      <div class="cart-drawer-body" id="cartDrawerBody">
        <div class="cart-empty">
          ...
          <h5 style="font-weight:700;color:#1a1a2e;margin-bottom:6px;">Cart is empty</h5>
          <p style="font-size:.85rem;color:#888;">Add instruments to build your enquiry.</p>
        </div>
      </div>
